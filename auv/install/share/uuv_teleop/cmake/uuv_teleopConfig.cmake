...
if("FALSE" STREQUAL "TRUE")
  set(uuv_teleop_SOURCE_PREFIX /home/robond/workspace/auv/src/uuv_simulator/uuv_teleop)
  set(uuv_teleop_DEVEL_PREFIX /home/robond/workspace/auv/devel)
  ...
  set(uuv_teleop_INSTALL_PREFIX /home/robond/workspace/auv/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'uuv_teleop' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Musa Morena Marcusso Manhaes <musa.marcusso@de.bosch.com>, Sebastian Scherer <sebastian.scherer2@de.bosch.com>, Luiz Ricardo Douat <luizricardo.douat@de.bosch.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'uuv_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/workspace/auv/install/${idir}'.  Ask the maintainer 'Musa Morena Marcusso Manhaes <musa.marcusso@de.bosch.com>, Sebastian Scherer <sebastian.scherer2@de.bosch.com>, Luiz Ricardo Douat <luizricardo.douat@de.bosch.com>' to fix it.")
    endif()
